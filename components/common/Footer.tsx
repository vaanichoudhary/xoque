...
//             <div>
//               <p className="text-[18px] font-bold tracking-[0.18em] uppercase text-[#0d0d1a]/45 mb-2"
//                 style={{ fontFamily: "var(--font-mono)" }}>Be first</p>
...
//   Company: ["About", "Blog"],
//   Support: ["Help Center", "Safety", "Community"],
//   Legal:   ["Privacy Policy", "Terms of Service", "Cookie Policy", "DMCA", "Data Protection"],
// };
...
// const AppStoreBadge = ({ size = 22 }: { size?: number }) => (
...
// const GooglePlayBadge = ({ size = 22 }: { size?: number }) => (
//   <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className="flex-shrink-0">
...
//             <a href="#"
//               className="flex-1 inline-flex items-center justify-center gap-2 px-3 py-2 rounded-[10px] border border-white/15 bg-white/[0.05] hover:bg-white/10 hover:border-white/28 transition-all">
//               <AppStoreBadge size={18} />
//               <div className="flex flex-col gap-0">
//                 <span className="text-[8px] text-white/40"
//                   style={{ fontFamily: "'Arimo', sans-serif" }}>Download on the</span>
//                 <span className="text-[12px] font-bold text-white leading-none"
//                   style={{ fontFamily: "'Arimo', sans-serif" }}>App Store</span>
//               </div>
//             </a>
//             <a href="#"
//               className="flex-1 inline-flex items-center justify-center gap-2 px-3 py-2 rounded-[10px] border border-white/15 bg-white/[0.05] hover:bg-white/10 hover:border-white/28 transition-all">
...
//               <div className="flex flex-col gap-0">
//                 <span className="text-[8px] text-white/40"
//                   style={{ fontFamily: "'Arimo', sans-serif" }}>Get it on</span>
//                 <span className="text-[12px] font-bold text-white leading-none"
//                   style={{ fontFamily: "'Arimo', sans-serif" }}>Google Play</span>
//               </div>
//             </a>
//           </div>
...
//             </div>
//             <div className="flex flex-wrap gap-3">
//               {["Privacy", "Terms", "DMCA", "Data Protection"].map(l => (
//                 <a key={l} href="#" className="text-[10px] text-white/20 hover:text-white/50 transition-colors"
//                   style={{ fontFamily: "var(--font-body)" }}>{l}</a>
//               ))}
//             </div>
...
//         {/* DESKTOP layout */}
//         <div className="hidden md:block pt-12 pb-8">
//           <div className="grid grid-cols-6 gap-6 lg:gap-8 mb-12">
...
//                 <a href="#"
//                   className="inline-flex items-center gap-2.5 px-4 py-2 rounded-[10px] border border-white/15 bg-white/[0.05] hover:bg-white/10 hover:border-white/28 transition-all"
//                   style={{ minWidth: "148px" }}>
//                   <AppStoreBadge size={22} />
//                   <div className="flex flex-col gap-0">
//                     <span className="text-[9px] text-white/45 tracking-[0.04em]"
//                       style={{ fontFamily: "'Arimo', sans-serif" }}>Download on the</span>
//                     <span className="text-[14px] font-bold text-white leading-none"
//                       style={{ fontFamily: "'Arimo', sans-serif", letterSpacing: "-0.01em" }}>App Store</span>
//                   </div>
//                 </a>
//                 <a href="#"
//                   className="inline-flex items-center gap-2.5 px-4 py-2 rounded-[10px] border border-white/15 bg-white/[0.05] hover:bg-white/10 hover:border-white/28 transition-all"
//                   style={{ minWidth: "148px" }}>
//                   <GooglePlayBadge size={22} />
//                   <div className="flex flex-col gap-0">
//                     <span className="text-[9px] text-white/45 tracking-[0.04em]"
//                       style={{ fontFamily: "'Arimo', sans-serif" }}>Get it on</span>
//                     <span className="text-[14px] font-bold text-white leading-none"
//                       style={{ fontFamily: "'Arimo', sans-serif", letterSpacing: "-0.01em" }}>Google Play</span>
//                   </div>
//                 </a>
//               </div>
//             </div>

//             {/* Link cols — 1 col each */}
//             {Object.entries(LINKS).map(([heading, items]) => (
//               <div key={heading} className="col-span-1 flex flex-col gap-3.5">
//                 <p className="text-[9px] font-bold tracking-[0.18em] uppercase text-white/25"
//                   style={{ fontFamily: "var(--font-mono)" }}>{heading}</p>
//                 <ul className="flex flex-col gap-2">
//                   {items.map(item => (
...
//             </p>
//             <div className="flex flex-wrap items-center gap-4">
//               {["Privacy Policy", "Terms of Service", "DMCA", "Data Protection", "Cookie Policy"].map(label => (
//                 <a key={label} href="#" className="text-[11px] text-white/22 hover:text-white/55 transition-colors"
//                   style={{ fontFamily: "var(--font-body)" }}>{label}</a>
//               ))}
//             </div>
...
//           {/* Ghost watermark */}
//           <div className="relative mt-4 overflow-hidden select-none pointer-events-none"
//             style={{ height: "clamp(50px, 10vw, 75px)" }}>
//             <span
//               className="absolute bottom-0 left-1/2 -translate-x-1/2 font-black text-white/[0.025] whitespace-nowrap"
//               style={{ fontFamily: "'Arimo', sans-serif", fontSize: "clamp(4rem, 14vw, 11rem)", letterSpacing: "-0.04em", lineHeight: 1 }}>
//               xoque
//             </span>
//           </div>
//         </div>
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8 lg:px-16">
        ...
        <div className="md:hidden pt-8 pb-6">
              ...
              <div key={heading}>
                ...
                <ul className="flex flex-col gap-1.5">
                  {items.map(item => (
                    <li key={item.label}>
                      <a href={item.href}
                        className="text-[11px] text-white/45 hover:text-white transition-colors leading-tight block"
                        style={{ fontFamily: "var(--font-body)" }}>
                        {item.label}
                      </a>
                    </li>
          ...
          <div className="flex gap-2.5 mb-6">
            <a href="/download"
              ...
              <AppStoreBadge size={18} />
              <div className="flex flex-col gap-0">
                <span className="text-[8px] text-white/40" style={{ fontFamily: "'Arimo', sans-serif" }}>Download on the</span>
                <span className="text-[12px] font-bold text-white leading-none" style={{ fontFamily: "'Arimo', sans-serif" }}>App Store</span>
              </div>
            </a>
            <a href="/download"
              className="flex-1 inline-flex items-center justify-center gap-2 px-3 py-2 rounded-[10px] border border-white/15 bg-white/[0.05] hover:bg-white/10 hover:border-white/28 transition-all">
              <GooglePlayBadge size={18} />
              <div className="flex flex-col gap-0">
                <span className="text-[8px] text-white/40" style={{ fontFamily: "'Arimo', sans-serif" }}>Get it on</span>
                <span className="text-[12px] font-bold text-white leading-none" style={{ fontFamily: "'Arimo', sans-serif" }}>Google Play</span>
              </div>
            </a>
          </div>
          ...
          <div className="border-t border-white/[0.07] pt-4 flex flex-col gap-2">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-1.5 text-[10px] text-white/20" style={{ fontFamily: "var(--font-mono)" }}>
                <span className="w-1.5 h-1.5 rounded-full" style={{ backgroundColor: "#c095e4" }} />
                imperfect but real.
              </div>
            </div>
            <div className="flex flex-wrap gap-3">
              {MOBILE_BOTTOM_LEGAL.map(l => (
        ...
        <div className="hidden md:block pt-12 pb-8">
            ...
            <div className="col-span-2 flex flex-col gap-4">
              ...
              <div className="flex flex-wrap gap-2.5 mt-1">
                <a href="/download"
                  ...
                  <AppStoreBadge size={22} />
                  <div className="flex flex-col gap-0">
                    <span className="text-[9px] text-white/45 tracking-[0.04em]" style={{ fontFamily: "'Arimo', sans-serif" }}>Download on the</span>
                    <span className="text-[14px] font-bold text-white leading-none" style={{ fontFamily: "'Arimo', sans-serif", letterSpacing: "-0.01em" }}>App Store</span>
                  </div>
                </a>
                <a href="/download"
                  className="inline-flex items-center gap-2.5 px-4 py-2 rounded-[10px] border border-white/15 bg-white/[0.05] hover:bg-white/10 hover:border-white/28 transition-all"
                  ...
                  <GooglePlayBadge size={22} />
                  <div className="flex flex-col gap-0">
                    <span className="text-[9px] text-white/45 tracking-[0.04em]" style={{ fontFamily: "'Arimo', sans-serif" }}>Get it on</span>
                    <span className="text-[14px] font-bold text-white leading-none" style={{ fontFamily: "'Arimo', sans-serif", letterSpacing: "-0.01em" }}>Google Play</span>
                  </div>
                </a>
              </div>
            </div>
          ...
          <div className="border-t border-white/[0.07] pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-1.5 text-[11px] text-white/18" style={{ fontFamily: "var(--font-mono)" }}>
              <span className="w-1.5 h-1.5 rounded-full" style={{ backgroundColor: "#c095e4" }} />
              Made for the real world
            </div>
          </div>
