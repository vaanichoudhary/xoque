...
export default function DmcaPage() {
  return (
    <LegalPage
      badge="Legal"
      title="DMCA Policy"
      subtitle="Copyright matters. Here's how we handle infringement notices and counter-notices."
      updated="March 1, 2026"
      accentColor={C.yellow}
      sections={[
        { title: "Our commitment", content: "xoque respects intellectual property rights and expects its users to do the same. We comply with the Digital Millennium Copyright Act (DMCA) and respond promptly to valid copyright infringement notices." },
        { title: "Filing a DMCA notice", content: ["Send a written notice to dmca@xoque.app. Your notice must include:", "Identification of the copyrighted work you claim has been infringed.", "Identification of the infringing content and where it appears on xoque.", "Your contact information (name, address, email, phone).", "A statement that you have a good faith belief the use is not authorised by the copyright owner.", "A statement that the information in the notice is accurate, under penalty of perjury."] },
        { title: "What happens next", content: "We'll review your notice and, if valid, remove or disable access to the infringing content within 48 hours. We'll notify the user who posted the content. Repeat infringers will have their accounts terminated." },
        { title: "Counter-notices", content: "If you believe your content was removed by mistake, you may file a counter-notice to dmca@xoque.app explaining why the content doesn't infringe. If we receive a valid counter-notice, we'll restore the content within 10–14 business days unless the original complainant files a court action." },
        { title: "False claims", content: "Filing a false DMCA notice is a serious matter. Under 17 U.S.C. § 512(f), you may be liable for damages if you knowingly misrepresent that content is infringing. We reserve the right to take action against bad-faith claims." },
        { title: "Contact", content: "Send all DMCA notices and counter-notices to dmca@xoque.app with 'DMCA Notice' in the subject line. We acknowledge all notices within 24 hours." },
      ]}
    />
  );
}